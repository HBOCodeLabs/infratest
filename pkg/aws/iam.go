...
// AssertIAMPolicyDocumentContainsResourceAction asserts that the provided IAM Policy Document contains a Statement with the given Resource, Action, and Effect.
...
// AssertIAMPolicyDocumentsContainResourceAction asserts _at least one_ of the provided IAM Policy Documents contains a Statement with the given Resource, Action, and Effect.
